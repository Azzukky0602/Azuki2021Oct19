...
if push == True:
    ...
    #馬主補正：三着内率＝X%、 20≦X＜30は1.1, 30≦X＜40は1.20, 40≦X＜50は1.3, 50≦X＜60は1.40
    #2024リーディング
    hyo2.loc[hyo2['owner'] == 'シルクレ', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == 'キャロッ', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == 'サンデー', 'TS'] = round(hyo2['TS'] * 1.05)

    #生産者補正：三着内率＝X%、 20≦X＜30は1.1, 30≦X＜40は1.20, 40≦X＜50は1.3, 50≦X＜60は1.40
    #2024リーディング
    hyo2.loc[hyo2['starion'] == 'ノーザン', 'TS'] = round(hyo2['TS'] * 1.05)
