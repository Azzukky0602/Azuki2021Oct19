...
#騎手補正：連帯率40%以上は1.1, 35-40%は1.075, 30-35%:1.05, 25-30%:1.025, 20-25%:1.00, 15-20%:0.975, 10-15%:0.95, 5-10%:0.925, 0-5%:0.90
    ...
    hyo2.loc[hyo2['騎手'] == 'Ｃデムーロ', '指数'] = hyo2['指数'] * 1.10
    ...
    hyo2.loc[hyo2['騎手'] == '横山武', '指数'] = hyo2['指数'] * 1.00 #目覚ましい活躍なので上方修正
    ...
    hyo2.loc[hyo2['騎手'] == '坂井', '指数'] = hyo2['指数'] * 0.975

    #連帯率10-15%
    hyo2.loc[hyo2['騎手'] == '大野', '指数'] = hyo2['指数'] * 0.950
    ...
    hyo2.loc[hyo2['騎手'] == '中村', '指数'] = hyo2['指数'] * 0.950
    ...
    hyo2.loc[hyo2['騎手'] == '荻野琢', '指数'] = hyo2['指数'] * 0.950
    ...
    hyo2.loc[hyo2['騎手'] == '内田博', '指数'] = hyo2['指数'] * 0.950
    hyo2.loc[hyo2['騎手'] == '荻野極', '指数'] = hyo2['指数'] * 0.950
    hyo2.loc[hyo2['騎手'] == '丸田', '指数'] = hyo2['指数'] * 0.950
    ...
    hyo2.loc[hyo2['騎手'] == '藤井勘', '指数'] = hyo2['指数'] * 0.925
