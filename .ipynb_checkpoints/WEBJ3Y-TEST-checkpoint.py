...
st.info('南関東はこちら  \nhttps://share.streamlit.io/azzukky0602/azuki2021oct19/main/WEBnankan442132.py')
st.info('園田・姫路・門別・地方交流はこちら  \nhttps://share.streamlit.io/azzukky0602/azuki2021oct19/main/WEBkoryu442132.py')
...
if push == True:
    ...
    #3歳　秋　補正　4戦以上
                    ...
                    if "東京優駿(G1)" in p_df.values or "皐月賞(G1)" in p_df.values:
                        if int(p_df[p_df['レース名'] == '東京優駿(G1)']['着順2']) <= 5 or int(p_df[p_df['レース名'] == '皐月賞(G1)']['着順2']) <= 5 \
                            or float(p_df[p_df['レース名'] == '東京優駿(G1)']['着差']) <= 0.5 or float(p_df[p_df['レース名'] == '皐月賞(G1)']['着差']) <= 0.5:
                        #春のクラシックで強かった馬は、全てのレース基準値を古馬と同等にする            
                    ...
                    #春のクラシックで弱かった馬は、３歳馬のレース基準値を適用する
                        base_number = []
                        for t in range(4):
...
#騎手補正：三着内率50%以上は1.3, 40-50%は1.20, 30-40%:1.10, 20-30%:1.05, それ以下は補正無し

    #三着内率50%以上
    hyo2.loc[hyo2['騎手'] == 'マーフィー', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == 'レーン', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == 'ルメール', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == '川田', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == 'Ｃデムーロ', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == '伴', '指数'] = hyo2['指数'] * 1.20
    hyo2.loc[hyo2['騎手'] == '平沢', '指数'] = hyo2['指数'] * 1.20    
    
    #三着内率40-50%
    hyo2.loc[hyo2['騎手'] == '高田', '指数'] = hyo2['指数'] * 1.10  
    hyo2.loc[hyo2['騎手'] == '横山武', '指数'] = hyo2['指数'] * 1.10
    hyo2.loc[hyo2['騎手'] == 'Ｍデムーロ', '指数'] = hyo2['指数'] * 1.10
    hyo2.loc[hyo2['騎手'] == '福永', '指数'] = hyo2['指数'] * 1.10
    hyo2.loc[hyo2['騎手'] == '石神', '指数'] = hyo2['指数'] * 1.10    
    hyo2.loc[hyo2['騎手'] == '北沢', '指数'] = hyo2['指数'] * 1.10

    #三着内率30-40%
    hyo2.loc[hyo2['騎手'] == '西谷誠', '指数'] = hyo2['指数'] * 1.05    
    hyo2.loc[hyo2['騎手'] == '小野寺', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '戸崎圭', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '武豊', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '横山典', '指数'] = hyo2['指数'] * 1.05    
    hyo2.loc[hyo2['騎手'] == '岩田望', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '熊沢', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '森一', '指数'] = hyo2['指数'] * 1.05    
    hyo2.loc[hyo2['騎手'] == '岩田康', '指数'] = hyo2['指数'] * 1.05
    hyo2.loc[hyo2['騎手'] == '藤岡佑', '指数'] = hyo2['指数'] * 1.05   

    #三着内率20-30%
    hyo2.loc[hyo2['騎手'] == '松山', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '五十嵐', '指数'] = hyo2['指数'] * 1.00
    ...
    hyo2.loc[hyo2['騎手'] == '菅原明', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '横山和', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '池添', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '西村淳', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '大江原', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '角田河', '指数'] = hyo2['指数'] * 1.00        
    hyo2.loc[hyo2['騎手'] == '田辺', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '鮫島克', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '菱田', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '石橋脩', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '内田博', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '幸', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '浜中', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '荻野極', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '丹内', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '石川', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '和田竜', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '岡田', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '難波', '指数'] = hyo2['指数'] * 1.00    
    hyo2.loc[hyo2['騎手'] == '松本', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '団野', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '北村宏', '指数'] = hyo2['指数'] * 1.00
    hyo2.loc[hyo2['騎手'] == '泉谷', '指数'] = hyo2['指数'] * 1.00     
    ...
    hyo3 = hyo2.iloc[:,[13,1,2,9,3,4,7,8,5,11,12]]
