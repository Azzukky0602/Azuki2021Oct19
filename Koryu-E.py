...
st.header('園田・姫路・門別・地方交流重賞　永久版')

st.write('   ')
st.info('【参考】テキトー指数の使い方  \nhttps://note.com/tekito_lab/n/n3342d6531772')
st.info('JRAはこちら  \nhttps://share.streamlit.io/azzukky0602/azuki2021oct19/main/JRA-E.py')
st.info('南関東はこちら  \nhttps://share.streamlit.io/azzukky0602/azuki2021oct19/main/Nankan-E.py')
...
#4戦以上出走している馬の指数                
    ...
    hyo1.loc[hyo1['騎手'] == '森泰斗', '指数'] = hyo1['指数'] * 1.20 #騎手補正：連帯率35%以上は1.15, 30-35%:1.1, 25-30%:1.05 
    ...
    hyo1.loc[hyo1['騎手'] == '下原理', '指数'] = hyo1['指数'] * 1.05
    ...
    hyo1.loc[hyo1['騎手'] == '永森大', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '西川敏', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '倉兼育', '指数'] = hyo1['指数'] * 1.15
    ...
    hyo1.loc[hyo1['騎手'] == '倉富隆', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '鮫島克', '指数'] = hyo1['指数'] * 1.05

    hyo1.loc[hyo1['騎手'] == '岡部誠', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '吉原寛', '指数'] = hyo1['指数'] * 1.05

    hyo1.loc[hyo1['騎手'] == '桑村真', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '五十冬', '指数'] = hyo1['指数'] * 1.00
    hyo1.loc[hyo1['騎手'] == '服部茂', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '阿部龍', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '石川倭', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '岩橋勇', '指数'] = hyo1['指数'] * 1.00
    hyo1.loc[hyo1['騎手'] == '宮崎光', '指数'] = hyo1['指数'] * 1.05
