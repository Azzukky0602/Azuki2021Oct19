...
#騎手補正：連帯率40以上:1.2, 35-40%:1.15, 30-35%:1.1, 25-30%:1.05     
    ...
    hyo1.loc[hyo1['騎手'] == '笹川翼', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '本田重', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '山崎誠', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '和田譲', '指数'] = hyo1['指数'] * 1.0   
    hyo1.loc[hyo1['騎手'] == '町田直', '指数'] = hyo1['指数'] * 1.0   
    hyo1.loc[hyo1['騎手'] == '張田昂', '指数'] = hyo1['指数'] * 1.05       
    hyo1.loc[hyo1['騎手'] == '本橋孝', '指数'] = hyo1['指数'] * 1.0  
    hyo1.loc[hyo1['騎手'] == '澤田達', '指数'] = hyo1['指数'] * 1.05    
    hyo1.loc[hyo1['騎手'] == '野澤憲', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '小牧太', '指数'] = hyo1['指数'] * 1.15
    ...
    hyo1.loc[hyo1['騎手'] == '鴨宮祥', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '田野豊', '指数'] = hyo1['指数'] * 1.0
    
    hyo1.loc[hyo1['騎手'] == '赤岡修', '指数'] = hyo1['指数'] * 1.20
    hyo1.loc[hyo1['騎手'] == '永森大', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '西川敏', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '倉兼育', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '宮川実', '指数'] = hyo1['指数'] * 1.20
    hyo1.loc[hyo1['騎手'] == '岡村卓', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '郷間勇', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '多田誠', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '加藤翔', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '塚本雄', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '佐原秀', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '中島龍', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '井上瑛', '指数'] = hyo1['指数'] * 1.05
    
    hyo1.loc[hyo1['騎手'] == '山口勲', '指数'] = hyo1['指数'] * 1.20
    hyo1.loc[hyo1['騎手'] == '飛田愛', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '真島正', '指数'] = hyo1['指数'] * 1.20    
    hyo1.loc[hyo1['騎手'] == '石川慎', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '倉富隆', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '鮫島克', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '竹吉徹', '指数'] = hyo1['指数'] * 1.05    
    hyo1.loc[hyo1['騎手'] == '山下裕', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '山田義', '指数'] = hyo1['指数'] * 1.05
    
    hyo1.loc[hyo1['騎手'] == '岡部誠', '指数'] = hyo1['指数'] * 1.15
    hyo1.loc[hyo1['騎手'] == '今井貴', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '大畑雅', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '加藤聡', '指数'] = hyo1['指数'] * 1.05     
    hyo1.loc[hyo1['騎手'] == '丸野勝', '指数'] = hyo1['指数'] * 1.05 
    hyo1.loc[hyo1['騎手'] == '丹羽克', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '村上弘', '指数'] = hyo1['指数'] * 1.0   
    hyo1.loc[hyo1['騎手'] == '宮下瞳', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '塚本征', '指数'] = hyo1['指数'] * 1.05

    hyo1.loc[hyo1['騎手'] == '桑村真', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '五十冬', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '服部茂', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '阿部龍', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '石川倭', '指数'] = hyo1['指数'] * 1.20
    hyo1.loc[hyo1['騎手'] == '岩橋勇', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '宮崎光', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '落合玄', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '阪野学', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '小野楓', '指数'] = hyo1['指数'] * 1.0
        
    hyo1.loc[hyo1['騎手'] == '山本聡', '指数'] = hyo1['指数'] * 1.15     
    hyo1.loc[hyo1['騎手'] == '村上忍', '指数'] = hyo1['指数'] * 1.10     
    hyo1.loc[hyo1['騎手'] == '山本政', '指数'] = hyo1['指数'] * 1.05 
    hyo1.loc[hyo1['騎手'] == '高松亮', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '木村暁', '指数'] = hyo1['指数'] * 1.05    
    hyo1.loc[hyo1['騎手'] == '高橋悠', '指数'] = hyo1['指数'] * 1.05
    hyo1.loc[hyo1['騎手'] == '坂口裕', '指数'] = hyo1['指数'] * 1.0
    hyo1.loc[hyo1['騎手'] == '陶文峰', '指数'] = hyo1['指数'] * 1.0

    hyo1.loc[hyo1['騎手'] == 'ルメー', '指数'] = hyo1['指数'] * 1.20
    hyo1.loc[hyo1['騎手'] == '川田将', '指数'] = hyo1['指数'] * 1.20    
    hyo1.loc[hyo1['騎手'] == '戸崎圭', '指数'] = hyo1['指数'] * 1.10
    hyo1.loc[hyo1['騎手'] == '坂井瑠', '指数'] = hyo1['指数'] * 1.10    
