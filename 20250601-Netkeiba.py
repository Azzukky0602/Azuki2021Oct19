...
if push == True:
    ...
    for horse in syusso_list:
        ...
        try:
            ...
            #3歳、3戦のみ
                ...
                if int(horse[18:]) == 3 and race_date <= dt(kotoshi, 6, 13).date():
        
                    base_number = []
                    for t in range(3):
                        #2歳時OP以上                    
                        if 'GIII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():  
                            kijun = 310        
                        elif 'GII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():
                            kijun = 320 
                        elif 'GI' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():
                            kijun = 350                                            
                        elif 'JpnIII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():  
                            kijun = 305                    
                        elif 'JpnII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():  
                            kijun = 315                    
                        elif 'JpnI' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():  
                            kijun = 335                    
                        elif 'L' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():
                            kijun = 300
                        elif 'OP' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] < dt(kotoshi, 1, 1).date():
                            kijun = 300
                            
                        #3歳レース
                        elif 'GIII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] > dt(kotoshi, 1, 1).date():  
                            kijun = 420
                        elif 'GII' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] > dt(kotoshi, 1, 1).date():
                            kijun = 440
                        elif 'GI' in npr[horse].iloc[t]['racename'] and npr[horse].iloc[t]['date'] > dt(kotoshi, 1, 1).date():
                ...
                elif int(horse[18:]) == 3 and race_date >= dt(kotoshi, 6, 14).date():
    ...
    hyo2.loc[hyo2['jockey'] == 'ルメール', 'TS'] = round(hyo2['TS'] * 1.19)
    hyo2.loc[hyo2['jockey'] == '川田', 'TS'] = round(hyo2['TS'] * 1.19)
    hyo2.loc[hyo2['jockey'] == '小牧加', 'TS'] = round(hyo2['TS'] * 1.16)   
    hyo2.loc[hyo2['jockey'] == '森一', 'TS'] = round(hyo2['TS'] * 1.16) 
    hyo2.loc[hyo2['jockey'] == '西谷誠', 'TS'] = round(hyo2['TS'] * 1.16)  
    hyo2.loc[hyo2['jockey'] == 'モレイラ', 'TS'] = round(hyo2['TS'] * 1.17)
    hyo2.loc[hyo2['jockey'] == 'Ｃデムーロ', 'TS'] = round(hyo2['TS'] * 1.15)
    hyo2.loc[hyo2['jockey'] == '戸崎圭', 'TS'] = round(hyo2['TS'] * 1.13)
    hyo2.loc[hyo2['jockey'] == '坂井', 'TS'] = round(hyo2['TS'] * 1.13)
    hyo2.loc[hyo2['jockey'] == 'ビュイック', 'TS'] = round(hyo2['TS'] * 1.13)
    hyo2.loc[hyo2['jockey'] == 'ムーア', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['jockey'] == '高田', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['jockey'] == '小坂', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['jockey'] == '武豊', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['jockey'] == 'マーカンド', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['jockey'] == '松山', 'TS'] = round(hyo2['TS'] * 1.10)
    hyo2.loc[hyo2['jockey'] == '横山武', 'TS'] = round(hyo2['TS'] * 1.10)
    hyo2.loc[hyo2['jockey'] == '上野', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['jockey'] == 'Ａルメート', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['jockey'] == '鮫島克', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['jockey'] == '岩田望', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['jockey'] == 'キング', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['jockey'] == '藤岡佑', 'TS'] = round(hyo2['TS'] * 1.08) 
    hyo2.loc[hyo2['jockey'] == '三浦', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['jockey'] == 'Ｍデムーロ', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['jockey'] == '佐々木', 'TS'] = round(hyo2['TS'] * 1.06)     
    hyo2.loc[hyo2['jockey'] == '西村淳', 'TS'] = round(hyo2['TS'] * 1.05)    
    hyo2.loc[hyo2['jockey'] == '田辺', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '五十嵐', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '菅原明', 'TS'] = round(hyo2['TS'] * 1.05)    
    hyo2.loc[hyo2['jockey'] == '北村友', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '浜中', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '石神深', 'TS'] = round(hyo2['TS'] * 1.05)    
    hyo2.loc[hyo2['jockey'] == '大江圭', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '横山和', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['jockey'] == '丹内', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['jockey'] == '池添', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['jockey'] == '団野', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['jockey'] == '横山典', 'TS'] = round(hyo2['TS'] * 1.04)    
    hyo2.loc[hyo2['jockey'] == '津村', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['jockey'] == '坂口', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['jockey'] == '岩田康', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['jockey'] == '金子', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['jockey'] == '伴', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['jockey'] == '中村', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['jockey'] == '江田勇', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['jockey'] == '斎藤', 'TS'] = round(hyo2['TS'] * 1.01)
    ...
    hyo2.loc[hyo2['jockey'] == '大野', 'TS'] = round(hyo2['TS'] * 1.00)
    hyo2.loc[hyo2['jockey'] == '幸', 'TS'] = round(hyo2['TS'] * 0.99)   
    hyo2.loc[hyo2['jockey'] == '北村宏', 'TS'] = round(hyo2['TS'] * 0.9)
    hyo2.loc[hyo2['jockey'] == '田口', 'TS'] = round(hyo2['TS'] * 0.99)
    hyo2.loc[hyo2['jockey'] == '吉田豊', 'TS'] = round(hyo2['TS'] * 0.99)
    hyo2.loc[hyo2['jockey'] == '吉村誠', 'TS'] = round(hyo2['TS'] * 0.99)   
    hyo2.loc[hyo2['jockey'] == '丸山', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '吉田隼', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '中井', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '草野', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '菊沢', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '柴田善', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '石橋脩', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '川又', 'TS'] = round(hyo2['TS'] * 0.98)
    hyo2.loc[hyo2['jockey'] == '亀田', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '角田和', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '鮫島良', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '国分恭', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '松若', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '岡田', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == '藤懸', 'TS'] = round(hyo2['TS'] * 0.97)
    hyo2.loc[hyo2['jockey'] == 'Ｈドイル', 'TS'] = round(hyo2['TS'] * 0.96) 
    hyo2.loc[hyo2['jockey'] == '秋山稔', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '酒井', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '太宰', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '松岡', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '杉原', 'TS'] = round(hyo2['TS'] * 0.96) 
    hyo2.loc[hyo2['jockey'] == '荻野琢', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '難波', 'TS'] = round(hyo2['TS'] * 0.96)
    hyo2.loc[hyo2['jockey'] == '黒岩', 'TS'] = round(hyo2['TS'] * 0.95)
    hyo2.loc[hyo2['jockey'] == '小林美', 'TS'] = round(hyo2['TS'] * 0.95)
    hyo2.loc[hyo2['jockey'] == '木幡初', 'TS'] = round(hyo2['TS'] * 0.95)
    hyo2.loc[hyo2['jockey'] == '横山琉', 'TS'] = round(hyo2['TS'] * 0.95)
    hyo2.loc[hyo2['jockey'] == '長岡', 'TS'] = round(hyo2['TS'] * 0.95)
    hyo2.loc[hyo2['jockey'] == '原', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '小林勝', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '川端', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '渡辺', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '小沢', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '松本', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '木幡巧', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '永島', 'TS'] = round(hyo2['TS'] * 0.94)
    hyo2.loc[hyo2['jockey'] == '富田', 'TS'] = round(hyo2['TS'] * 0.93)
    hyo2.loc[hyo2['jockey'] == '武藤', 'TS'] = round(hyo2['TS'] * 0.93)
    hyo2.loc[hyo2['jockey'] == '井上', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '古川吉', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '今村', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '小崎', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '野中', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '内田博', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '加藤', 'TS'] = round(hyo2['TS'] * 0.92)
    hyo2.loc[hyo2['jockey'] == '丸田', 'TS'] = round(hyo2['TS'] * 0.91)
    hyo2.loc[hyo2['jockey'] == '小野寺', 'TS'] = round(hyo2['TS'] * 0.91)
    hyo2.loc[hyo2['jockey'] == '古川奈', 'TS'] = round(hyo2['TS'] * 0.91)
    hyo2.loc[hyo2['jockey'] == '木幡育', 'TS'] = round(hyo2['TS'] * 0.91)
    hyo2.loc[hyo2['jockey'] == '泉谷', 'TS'] = round(hyo2['TS'] * 0.91)
    hyo2.loc[hyo2['jockey'] == '黛', 'TS'] = round(hyo2['TS'] * 0.90)
    hyo2.loc[hyo2['jockey'] == '国分優', 'TS'] = round(hyo2['TS'] * 0.90)
    hyo2.loc[hyo2['jockey'] == '嶋田', 'TS'] = round(hyo2['TS'] * 0.90) 
    hyo2.loc[hyo2['jockey'] == '宮崎', 'TS'] = round(hyo2['TS'] * 0.90)
    hyo2.loc[hyo2['jockey'] == '小林脩', 'TS'] = round(hyo2['TS'] * 0.89)   
    hyo2.loc[hyo2['jockey'] == '鷲頭', 'TS'] = round(hyo2['TS'] * 0.89)
    hyo2.loc[hyo2['jockey'] == '橋木', 'TS'] = round(hyo2['TS'] * 0.89)
    hyo2.loc[hyo2['jockey'] == '高倉', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '田中健', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '石田', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '江田照', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '柴田大', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '小林凌', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '川須', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '水沼', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '佐藤', 'TS'] = round(hyo2['TS'] * 0.88)
    hyo2.loc[hyo2['jockey'] == '土田', 'TS'] = round(hyo2['TS'] * 0.88)
    
    
    #馬主補正：2024リーディング
    
    hyo2.loc[hyo2['owner'] == '草間庸文', 'TS'] = round(hyo2['TS'] * 1.18)
    hyo2.loc[hyo2['owner'] == '大野照旺', 'TS'] = round(hyo2['TS'] * 1.17)
    hyo2.loc[hyo2['owner'] == '吉澤ホー', 'TS'] = round(hyo2['TS'] * 1.16)
    hyo2.loc[hyo2['owner'] == 'ＴＮレー', 'TS'] = round(hyo2['TS'] * 1.15)
    hyo2.loc[hyo2['owner'] == '窪田芳郎', 'TS'] = round(hyo2['TS'] * 1.14)
    hyo2.loc[hyo2['owner'] == '前田晋二', 'TS'] = round(hyo2['TS'] * 1.13)
    hyo2.loc[hyo2['owner'] == '平田修', 'TS'] = round(hyo2['TS'] * 1.13)
    hyo2.loc[hyo2['owner'] == '野田みづ', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['owner'] == '幅田京子', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['owner'] == '河合純二', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['owner'] == '猪熊広次', 'TS'] = round(hyo2['TS'] * 1.10)
    hyo2.loc[hyo2['owner'] == '石川達絵', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['owner'] == '吉田勝己', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['owner'] == '藤田晋', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['owner'] == '長谷川祐', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['owner'] == '嶋田賢', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['owner'] == '寺田寿男', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['owner'] == '前田幸治', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['owner'] == 'キーファ', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['owner'] == '青山洋一', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['owner'] == 'キャロッ', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['owner'] == '近藤旬子', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['owner'] == 'ライフハ', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['owner'] == '吉田千津', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['owner'] == '谷掛龍夫', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == '原村正紀', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == 'サンデー', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == 'ロードホ', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['owner'] == 'ＤＭＭド', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['owner'] == 'ダノック', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['owner'] == 'ノースヒ', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['owner'] == '吉川潤', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['owner'] == '名古屋友', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['owner'] == 'シルクレ', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['owner'] == '土井肇', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['owner'] == '里見治', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['owner'] == '下河辺隆', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['owner'] == '小笹芳央', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['owner'] == 'ゴドルフ', 'TS'] = round(hyo2['TS'] * 1.01)
    ...
    hyo2.loc[hyo2['starion'] == '土居牧場', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['starion'] == 'Godo', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['starion'] == 'バンブー', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['starion'] == '川越ファ', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['starion'] == 'レイクヴ', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == 'ケイアイ', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == '北勝ファ', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == '須崎牧場', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == 'グランド', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == '梅田牧場', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['starion'] == 'ノーザン', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['starion'] == '谷川牧場', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['starion'] == 'ノースヒ', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['starion'] == 'ケイズ', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['starion'] == '桑田牧場', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['starion'] == '竹島幸治', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['starion'] == '社台コー', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['starion'] == '錦岡牧場', 'TS'] = round(hyo2['TS'] * 1.05)
    hyo2.loc[hyo2['starion'] == '本間牧場', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['starion'] == 'タイヘイ', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['starion'] == '服部牧場', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['starion'] == '伏木田牧', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['starion'] == '中原牧場', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['starion'] == '下河辺牧', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['starion'] == 'フジワラ', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['starion'] == 'オリエン', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['starion'] == '社台ファ', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '秋場牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '村上欽哉', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '辻牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == 'スマイル', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '三嶋牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '坂東牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '宮内牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '協和牧場', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['starion'] == '浜本牧場', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['starion'] == 'チャンピ', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['starion'] == '木村牧場', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['starion'] == 'ＡＳＫＳ', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['starion'] == '日高大洋', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['starion'] == 'コスモヴ', 'TS'] = round(hyo2['TS'] * 1.01)
    ...
    hyo2.loc[hyo2['stable'] == '美浦田中博', 'TS'] = round(hyo2['TS'] * 1.21)
    hyo2.loc[hyo2['stable'] == '栗東上村', 'TS'] = round(hyo2['TS'] * 1.20)
    hyo2.loc[hyo2['stable'] == '栗東中内田', 'TS'] = round(hyo2['TS'] * 1.18)
    hyo2.loc[hyo2['stable'] == '美浦堀', 'TS'] = round(hyo2['TS'] * 1.17)
    hyo2.loc[hyo2['stable'] == '栗東友道', 'TS'] = round(hyo2['TS'] * 1.16)
    hyo2.loc[hyo2['stable'] == '美浦木村', 'TS'] = round(hyo2['TS'] * 1.16)
    hyo2.loc[hyo2['stable'] == '栗東杉山晴', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['stable'] == '栗東須貝', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['stable'] == '栗東福永', 'TS'] = round(hyo2['TS'] * 1.12)
    hyo2.loc[hyo2['stable'] == '美浦鹿戸', 'TS'] = round(hyo2['TS'] * 1.11)
    hyo2.loc[hyo2['stable'] == '美浦菊沢', 'TS'] = round(hyo2['TS'] * 1.10)
    hyo2.loc[hyo2['stable'] == '栗東藤原', 'TS'] = round(hyo2['TS'] * 1.10)
    hyo2.loc[hyo2['stable'] == '栗東吉岡', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['stable'] == '栗東斉藤崇', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['stable'] == '美浦宮田', 'TS'] = round(hyo2['TS'] * 1.09)
    hyo2.loc[hyo2['stable'] == '栗東松永幹', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '栗東池添', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '美浦森一', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '美浦加藤征', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '栗東牧浦', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '美浦手塚', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '栗東高野', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '美浦上原佑', 'TS'] = round(hyo2['TS'] * 1.08)
    hyo2.loc[hyo2['stable'] == '栗東武幸', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['stable'] == '美浦萩原', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['stable'] == '美浦中舘', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['stable'] == '栗東田中克', 'TS'] = round(hyo2['TS'] * 1.07)
    hyo2.loc[hyo2['stable'] == '栗東矢作', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['stable'] == '栗東四位', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['stable'] == '美浦高木', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['stable'] == '栗東奥村豊', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['stable'] == '栗東大久保', 'TS'] = round(hyo2['TS'] * 1.06)
    hyo2.loc[hyo2['stable'] == '栗東安田', 'TS'] = round(hyo2['TS'] * 1.06)
    ...
    hyo2.loc[hyo2['stable'] == '栗東長谷川', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '栗東新谷', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '美浦稲垣', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '美浦国枝', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '栗東中竹', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '美浦戸田', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '栗東藤岡', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '栗東浜田', 'TS'] = round(hyo2['TS'] * 1.04)
    hyo2.loc[hyo2['stable'] == '栗東吉村', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['stable'] == '美浦栗田', 'TS'] = round(hyo2['TS'] * 1.03)
    hyo2.loc[hyo2['stable'] == '美浦和田正', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '美浦伊藤圭', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '美浦竹内', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '栗東橋口', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '栗東杉山', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '栗東角田', 'TS'] = round(hyo2['TS'] * 1.02)
    hyo2.loc[hyo2['stable'] == '栗東岡田', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '美浦牧', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '栗東池江', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '栗東西村', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '美浦武井', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '栗東音無', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '栗東石坂', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '美浦大竹', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '栗東清水久', 'TS'] = round(hyo2['TS'] * 1.01)
    hyo2.loc[hyo2['stable'] == '美浦久保田', 'TS'] = round(hyo2['TS'] * 1.01) 
